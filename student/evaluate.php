			...
			<div class="card card-outline card-info">
				...
				<div class="card-body">
					...
					<form id="manage-evaluation">
						...
						<input type="hidden" name="batch_id" value="<?php echo $_SESSION['login_batch_id'] ?>">
									...
									?>
										<tr class="bg-white">
											<td class="p-1" width="40%">
												...
												<input type="hidden" name="qid[]" value="<?php echo $row['id'] ?>" required>
											</td>
											<?php for ($c = 1; $c <= 3; $c++) : ?>
												<td class="text-center">
													<div class="icheck-success d-inline">
														<input type="radio" name="rate[<?php echo $row['id'] ?>]" id="qradio<?php echo $row['id'] . '_' . $c ?>" value="<?php echo $c ?>" required>
						...
						<?php endwhile; ?>
						<div class="card-tools d-flex justify-content-end"> <!-- Add flexbox utility classes -->
