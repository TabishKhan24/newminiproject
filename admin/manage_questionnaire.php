			...
			<div class="card card-outline card-info">
				<div class="card-header">
					<b>Evaluation Questionnaire for Academic
						<?php
						echo "Year: $year Semester: $semester : $feedback_type"; // Debugging statement
						if ($year != '0000' && $semester != '00') {
						//	echo $year . ' ' . (ordinal_suffix($semester));
						} else {
							echo 'Unknown';
						}
						?>
										...
										<tr class="bg-white">
											<td class="p-1 text-center" width="5px">
												<span class="btn-group dropright">
													...
													<!-- Place the comment section after the loop that generates radio button options -->
												</span>
											</td>
