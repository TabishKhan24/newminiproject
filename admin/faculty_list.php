			...
			<table class="table tabe-hover table-bordered" id="list">
				<thead>
					<tr>
						...
						<th class="text-center">Institution ID</th>
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM faculty_list order by cast(school_id as UNSIGNED) asc");
