    ...
    <div class="card-body">
      ...
      <div class="col-md-5">
        <div class="callout callout-info">
          <h5><b>Academic Year: <?php echo $_SESSION['academic']['year']?></b> <b>Semester: <?php echo (ordinal_suffix1($_SESSION['academic']['semester']))?></b></h5>
...
<div class="row">
  ...
  <div class="col-12 col-sm-6 col-md-4">
    <div class="small-box bg-light shadow-sm border">
      <div class="inner">
        <h3><?php echo $conn->query("SELECT * FROM batch_list")->num_rows; ?></h3>
        <p>Total Batches</p>
      </div>
      <div class="icon">
        <i class="fa fa-list-alt"></i>
