						...
						<div class="callout callout-info">
							...
							?>
								<div class="d-flex justify-content-between w-100">
									<label for=""><b>Feedback Type List</b></label>
...
<script>
	$(document).ready(function() {
		...
		$('.delete_criteria').click(function() {
			_conf("Are you sure to delete this feedback type?", "delete_criteria", [$(this).attr('data-id')])
		})
	...
	function make_default($id) {
		...
		$.ajax({
			...
			success: function(resp) {
				if (resp == 1) {
					alert_toast("Defaut criteria year updated", 'success')
					setTimeout(function() {
						location.reload()
					}, 1500)
				}
