	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_subject" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New Subject</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-center"><b><?php echo $row['subject'] ?></b></td>
							<td class="text-center"><b><?php echo $row['code'] ?></b></td>
							<td class="text-center"><b><?php echo $row['course_type'] ?></b></td>
