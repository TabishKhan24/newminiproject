...
<div class="container-fluid">
	<form action="" id="manage-academic">
		...
		<div class="form-group">
			<label for="feedback_type" class="control-label">Feedback Type</label>
			<input type="text" class="form-control form-control-sm" name="feedback_type" id="feedback_type" value="<?php echo isset($feedback_type) ? $feedback_type : '' ?>" required>
		</div>
		<?php if (isset($status)) : ?>
			<div class="form-group">
